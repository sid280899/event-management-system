...
app.use(cors({
  origin: [
    'http://localhost:5173',
    'http://127.0.0.1:5173',
    'https://event-management-system-wy4i.vercel.app', // Stable frontend domain
    'https://event-manageme-git-af4ebe-siddheshneharkar70-gmailcoms-projects.vercel.app', // Stable frontend domain
